...
final class CustomEnd_Harriet {
    ...
    public function render_admin_page() {
        ...
        $endpoints = array(
            array(
                'name'   => 'Size Chart (GET)',
                'route'  => 'acf/v1/products/{id}',
                'method' => 'GET',
                'desc'   => 'Retrieve product size chart by product ID',
            ),
            array(
                'name'   => 'Size Chart Upload (POST)',
                'route'  => 'acf/v1/products/{id}/size-chart',
                'method' => 'POST',
                'desc'   => 'Upload size chart image/PDF for a product',
            ),
            array(
                'name'   => 'Best Sellers',
                'route'  => 'custom/v1/best-sellers',
                'method' => 'GET',
                'desc'   => 'Top-selling products with date range & vendor filtering',
            ),
            array(
                'name'   => 'Deals',
                'route'  => 'wc/v3/deals',
                'method' => 'GET',
                'desc'   => 'Active sale products with discount/date/vendor/category filters',
            ),
            array(
                'name'   => 'Product SEO Info',
                'route'  => 'wc/v3/product-info/{slug}',
                'method' => 'GET',
                'desc'   => 'Single product SEO metadata (Rank Math)',
            ),
            array(
                'name'   => 'Batch Products Info',
                'route'  => 'wc/v3/products-info?slugs=slug1,slug2',
                'method' => 'GET',
                'desc'   => 'Batch product SEO metadata (up to 20)',
            ),
            array(
                'name'   => 'Category SEO Info',
                'route'  => 'wc/v3/category-info/{slug}',
                'method' => 'GET',
                'desc'   => 'Single category SEO metadata',
            ),
            array(
                'name'   => 'Batch Categories Info',
                'route'  => 'wc/v3/categories-info?slugs=slug1,slug2',
                'method' => 'GET',
                'desc'   => 'Batch category SEO metadata (up to 20)',
            ),
            array(
                'name'   => 'Register Vendor',
                'route'  => 'custom/v1/register-vendor',
                'method' => 'POST',
                'desc'   => 'Register a new Dokan vendor (multi-step)',
            ),
            array(
                'name'   => 'Check Email',
                'route'  => 'custom/v1/check-email?email=test@example.com',
                'method' => 'GET',
                'desc'   => 'Check if email is already registered',
            ),
            array(
                'name'   => 'Check Shop URL',
                'route'  => 'custom/v1/check-shop-url?shop_url=my-store',
                'method' => 'GET',
                'desc'   => 'Check if shop slug is available',
            ),
            array(
                'name'   => 'Products by Category',
                'route'  => 'wc/v3/products/by-category/{slug}',
                'method' => 'GET',
                'desc'   => 'Products filtered by category with price/stock/pagination',
            ),
            array(
                'name'   => 'Products by Tag',
                'route'  => 'wc/v3/products/by-tag/{slug}',
                'method' => 'GET',
                'desc'   => 'Products filtered by tag with price/stock/pagination',
            ),
        );
        ?>
        <div class="wrap">
